...
export const CTX_SHOP_ID = 'CTX_SHOP_ID'; // 网关 Shop.id
export const CTX_SHOP_HINT = 'CTX_SHOP_HINT'; // 店名／别名，供 resolveShop
export const CTX_KEYWORD_HINTS = 'CTX_KEYWORD_HINTS'; // 关键词素材，注入 AI
